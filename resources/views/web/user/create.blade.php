    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <h5>Add New User</h5>
                    {{ html()->form('POST', route('user.save'))->class('pt-3')->open() }}
                    @csrf
                    <div class="row">
                        <div class="form-group col-md-3">
                            <label>Name *</label>
                            {{ html()->text('name', old('name'))->class('form-control form-control-lg')->placeholder('Name') }}
                            @error('name')
                        ...
                        <div class="mt-3">
                            {{ html()->submit('Save')->class('btn btn-block btn-submit btn-primary btn-lg font-weight-medium auth-form-btn') }}
                        </div>
                    </div>
                    {{ html()->form()->close() }}
                </div>
